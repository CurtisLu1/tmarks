...
import { Archive, ArrowLeft, BarChart3, Globe, Layers, Share2, TrendingUp } from 'lucide-react';
...
export default function StatisticsPage() {
  ...
  return (
    <div className={`h-screen flex flex-col bg-background ${isMobile ? 'overflow-hidden' : ''}`}>
      {isMobile && <MobileHeader title="使用统计" showMenu={false} showSearch={false} showMore={false} />}
                    ...
                    <div className="flex-1">
                      ...
                      <div className="w-full bg-muted rounded-full h-2">
                        <div
                          ...
                          style={{
                            width: `${
                              statistics.top_domains[0]
                                ? (domain.count / statistics.top_domains[0].count) * 100
                                : 0
                            }%`,
                          }}
                        />
                        ...
                        <div className="w-full bg-muted rounded-full h-8">
                          <div
                            ...
                            style={{
                              width: `${
                                (item.count /
                                  Math.max(...statistics.group_size_distribution.map((d) => d.count))) *
                                100
                              }%`,
                              minWidth: '60px',
                            }}
