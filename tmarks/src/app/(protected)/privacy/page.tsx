  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-6 sm:space-y-8">
      ...
      <div className="space-y-4">
        ...
        <div className="card p-6 space-y-4">
          <p className="text-sm text-muted-foreground">我们采取多种安全措施来保护您的个人信息：</p>
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
        ...
        <div className="card p-6">
          <ul className="space-y-3 text-sm text-muted-foreground">
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span>
              <span>
                <strong>访问权</strong>：您可以随时访问和查看您的个人信息
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span>
              <span>
                <strong>修改权</strong>：您可以更新或修改您的个人信息
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span>
              <span>
                <strong>删除权</strong>：您可以请求删除您的账户和所有相关数据
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-primary mt-0.5">•</span>
              <span>
                <strong>导出权</strong>：您可以导出您的书签数据
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="card p-6 space-y-3">
          <p className="text-sm text-muted-foreground">我们使用 Cookie 和类似技术来：</p>
      ...
      <div className="space-y-4">
        ...
        <div className="card p-6">
          <p className="text-sm text-muted-foreground">
            我们可能会不时更新本隐私政策。重大变更时，我们会通过电子邮件或服务内通知告知您。继续使用服务即表示您接受更新后的政策。
          </p>
        </div>
      </div>
      ...
      <div className="card p-6 space-y-3">
        ...
        <p className="text-sm text-muted-foreground">如果您对本隐私政策有任何疑问或建议，请通过以下方式联系我们：</p>
        <div className="text-sm text-muted-foreground">
          <p>
            电子邮件：
            <a href="mailto:privacy@tmarks.com" className="text-primary hover:underline">
              privacy@tmarks.com
            </a>
          </p>
        </div>
