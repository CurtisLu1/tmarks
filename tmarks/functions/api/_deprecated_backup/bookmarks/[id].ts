...
import type { Env, BookmarkRow, SQLParam } from '../../../lib/types'
...
export const onRequestPatch: PagesFunction<Env, 'id', ApiKeyAuthContext>[] = [
...
export const onRequestDelete: PagesFunction<Env, 'id', ApiKeyAuthContext>[] = [
